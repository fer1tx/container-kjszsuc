...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kjszsuc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kjszsuc.containers.anotherwebservice.com/
...
```
git clone git@github.com:fer1tx/container-kjszsuc.git
cd container-kjszsuc
```
...
```
docker attach container-kjszsuc
```
